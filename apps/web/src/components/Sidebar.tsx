    ...
    return (
        <div style={{
            ...
            <section style={{padding: "12px 14px 8px", borderBottom: "1px solid #0a1e33"}}>
                <div style={{fontSize: 9, letterSpacing: "0.15em", color: "#2a5a7a", marginBottom: 8}}>STATIC LAYERS
                </div>
            ...
            <section style={{padding: "10px 14px 8px", borderBottom: "1px solid #0a1e33"}}>
              ...
              <span style={{fontSize: 8, color: "#4a7a8a"}}>
                STREAM: <span
                  style={{color: flightStreamStatus === "live" ? "#00ff88" : "#f59e0b"}}>{flightStreamStatus.toUpperCase()}</span>
              </span>
            ...
            {/* ── Branch filter ── */}
            <section style={{padding: "10px 14px 8px", borderBottom: "1px solid #0a1e33"}}>
                <div style={{fontSize: 9, letterSpacing: "0.15em", color: "#2a5a7a", marginBottom: 8}}>BRANCH FILTER
                </div>
            ...
            <section style={{padding: "10px 14px", flex: 1, overflow: "auto"}}>
                <div style={{fontSize: 9, letterSpacing: "0.15em", color: "#2a5a7a", marginBottom: 8}}>SELECTED OBJECT
                </div>
                {selected ? (
    ...
    return (
        <div onClick={onToggle}
             style={{
                 ...
                 border: `1px solid ${active ? "#1a4060" : "transparent"}`
             }}>
            <div style={{
                width: 14,
                height: 14,
                borderRadius: 2,
                border: `2px solid ${active ? ld.color : "#2a4a5a"}`,
                background: active ? ld.color + "33" : "transparent",
                display: "flex",
                alignItems: "center",
            ...
            <span
                style={{fontSize: 10, color: active ? "#c8d8e8" : "#4a6a7a", letterSpacing: "0.06em"}}>{ld.label}</span>
            <div style={{flex: 1}}/>
