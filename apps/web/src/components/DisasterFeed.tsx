                        ...
                        return (
                            ...
                            >
                                ...
                                <div style={{flex: 1, minWidth: 0}}>
                                    ...
                                    <div style={{fontSize: 8, color: "#2a5a7a"}}>{q.depth.toFixed(0)}km
                                        · {timeAgo(q.time)}</div>
                                </div>
                            ...
                            >
                                ...
                                <div style={{flex: 1, minWidth: 0}}>
                                    ...
                                    <div style={{
                                        fontSize: 8,
                                        color: "#2a5a7a"
                                    }}>{style.label} · {timeAgo(new Date(e.date).getTime())}</div>
                                </div>
                                {!e.closed && <span style={{
                                    fontSize: 7,
                                    color: "#ff4d6d",
